...
<div class="h-screen w-screen py-20">
	...
	<article class="card mx-auto max-w-lg p-3">
		<h1 class="chead p-3 text-center">Sign Up</h1>
		<form class="grid gap-3" action="?/signup" method="POST">
			<input placeholder="Type Name" class="input px-4 py-2" type="text" name="name" id="" />
